...
select age, loan, job, `default` from bank_details;
...
select * from bank_details
where education = ('Unknown' OR marital = 'single') AND balance < 500;
...
FROM bank_details;
SELECT *
from bank_details order by Balance Limit 1;
SELECT*
from bank_details order by  balance ASc;
select* 
from bank_details where loan = 'yes';
select  count(loan)
from bank_details where loan = 'yes';
Select avg(balance)
from bank_details where job = 'admin.';

select * 
from bank_details  where job = 'unknown' AND age<45;
select * 
from bank_details  where education = 'primary' AND job= 'unknown';
select * 
from bank_details  where balance<0;
